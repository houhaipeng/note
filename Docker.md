...
-v /mydata/redis/node-${port}/conf:/etc/redis/redis.conf \
-d --net redis \
--ip 172.38.0.1${port} redis:5.0.9-alpine3.11 redis-server /etc/redis/redis.conf
# 以1为例
docker run -p 6371:6379 -p 16371:16379 --name redis-1 \
-v /mydata/redis/node-1/data:/data \
-v /mydata/redis/node-1/conf:/etc/redis/redis.conf \
